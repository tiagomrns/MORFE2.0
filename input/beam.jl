...
info.Fmult=0.5*[5.0];#0.5369754008568333^2*[0.5]  # with these amplitudes
info.omega_mul=1.0/3.0 # moltiplicatore della frequenza delle forzante NON ATTIVO
info.style = 'c'
info.max_order = 11
info.max_orderNA = 11
# faccio una directory unica che contiene nel nome l'ordine della parametrizzazione e info
dirout=compose_name_output_dir("beam", info)
